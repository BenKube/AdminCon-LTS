...
/* AdminCon 8.0 Command Line Interface Edition - Source Code - ProcessQuery.cs
* Intro: Print all processes with their details.
* Architecture: .NET Core 3.x & .NET Framework 4.x
* (c) 2017-2021 Project Amadeus. All rights reserved.*/
namespace AdminCon_CLI_dotnetEdition.Components.Processes
{
    /// <summary>
    /// Print all processes with their details.
    /// </summary>
    class ProcessQuery
    {
        readonly ProcessAlgorithms processAlgorithms = new ProcessAlgorithms();
        public void ListProcesses(Int32 flag) //Print all processes and their RAM usage
        {
            if(flag == 0)
            {
            ...
            else if (flag == -1)
            {
                ...
                pList.Sort(new Amadeus.Microsoft.Windows.CsharpDev.ToolBox.Security.PNAMEComparer()); //Project Amadeus: Desktop Development Kit
                ConsoleHL.WriteTitle("PID:" + PrintSpaces(6) + "Process Name:" + PrintSpaces(37) + "Memory Usage:" + "\n" +
                    "=========================================================================" + "\n");
                foreach (Process p in pList)
                {
