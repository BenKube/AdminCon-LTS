...
/* AdminCon 8.0 Command Line Interface Edition - Source Code - PrintOSInfo.cs
...
{
    /// <summary>
    /// Print OS-info and hardware info
    /// </summary>
    class PrintOSInfo
    {
        public void PrintSystemInfo()
        {
            ...
            {
                ConsoleHL.WriteInfo(LOGICAL_DRIVES[i] + "      "); //Print all available logical partitions
            }
            ConsoleHL.WriteOutput("\n\n||   Available IPv4-IPv6: \n");
            for (Int32 i = 0; i < ipadrlst.Length; i++)
            {
                ConsoleHL.WriteInfo("\n        "+ipadrlst[i] + "\n"); //Print available IPv4 and IPV6 addresses.
            }
            HardwareInfo hardwareInfo = new HardwareInfo();
            hardwareInfo.printHardwareInfo();
            Console.WriteLine("\n\n********************************\n\n");
            #endregion
