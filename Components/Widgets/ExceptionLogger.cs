...
using System.Text;
/* AdminCon 8.0 Command Line Interface Edition - Source Code - ExceptionLogger.cs
...
namespace AdminCon_CLI_dotnetEdition.Components.Widgets
{
    ...
    {
        private readonly Int32 MAXIMUM_EXCEPTION_TRACE_CAPACITY = 10;
        ...
        public void Add(Exception ex)
        {
            ...
            if (this.exceptionsTrace.Count > MAXIMUM_EXCEPTION_TRACE_CAPACITY) this.exceptionsTrace.Clear();
        }
