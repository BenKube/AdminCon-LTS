    ...
    class DataBarGenerator
    {
        ...
        public DataBarGenerator()
        {
            ...
            while (true)
            {
                ...
                ConsoleHL.WriteCyanLine(this.Generate((Int32)(daemon.mem_Usage_Ratio*100), daemon.Memory_Usage, "MB"));
        ...
        private String Generate(Int32 ratio, Double value, String unit)
        {
        ...
        /// <param name="ratio"></param>
        /// <returns>Output String</returns>
        private String Generate(Int32 ratio)
        {
            StringBuilder stringBuilder = new StringBuilder();
        ...
        private String PrintBlocks(Int32 blocks)
        {
            StringBuilder stringBuilder = new StringBuilder();
