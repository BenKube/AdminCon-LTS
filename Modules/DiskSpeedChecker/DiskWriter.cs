...
namespace AdminCon_CLI_dotnetEdition.Modules.DiskSpeedChecker
{
    internal class DiskWriter
    {
        ...
        internal static void Write(Int32 size/*MB*/)
        {
            //Issue Mar.2022: High Memory Consumption.
            Stopwatch stopwatch = new Stopwatch();
            stopwatch.Start();
            Int32 sizeInByte = size * 1024 * 1024;
    ...
    internal static class CharPool
    {
        ...
        private static Int32 bufferSize = 8; //byte
        ...
        /// <returns></returns>
        public static List<List<Char>> Generate(Int32 count)
        {
